...
func inits(ctx context.Context, ingressClassList *networkingv1.IngressClassList, loggingClients ...*Logging.Client) *Controller {
	return initsWithCustomClients(ctx, ingressClassList, &MockLoadBalancerClient{}, &MockPrivateIpClient{}, loggingClients...)
}

func initsWithCustomClients(ctx context.Context, ingressClassList *networkingv1.IngressClassList, lbClient ociclient.LoadBalancerInterface, privateIPClient ociclient.PrivateIpInterface, loggingClients ...*Logging.Client) *Controller {
	...
	wrapperClient := client.NewWrapperClient(k8client, firewallClient, loadBalancerClient, privateIPClient, nil, nil, loggingClients...)
